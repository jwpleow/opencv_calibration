...
const int calibration_flags = cv::CALIB_ZERO_TANGENT_DIST | cv::CALIB_FIX_INTRINSIC | cv::CALIB_TILTED_MODEL | cv::CALIB_THIN_PRISM_MODEL | cv::CALIB_RATIONAL_MODEL;
// const int calibration_flags = cv::CALIB_FIX_INTRINSIC;
